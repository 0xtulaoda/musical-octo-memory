...
import { addTwitterOwner, findTwitterFollowerList, searchByUserName } from '@/services/TwitterScan';
...
interface FollowerOwner {
  match: any;
}

const FollowerList: React.FC = (props: FollowerOwner) => {
  /**
  ...
  return (
    <PageContainer>
      <ProTable<TwitterUser, API.PageParams>
        ...
        //   const res = await findTwitterFollowerList({
        //     page: params.current,
        ...
        request={async (params: any) => {
          ...
          const [result, error] = await tryCatch(findTwitterFollowerList, {
            page: params.current,
            pageSize: params.pageSize,
            followerOwnerId,
            ...params,
